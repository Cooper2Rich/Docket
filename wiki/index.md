...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the workspace leaf is integrated and the server-rendered web foundation is proposed in PR #169 pending exact-head evidence, bootstrap CI, and controller-verified protected integration.
