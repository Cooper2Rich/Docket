...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first six foundation leaves are integrated, while module-owned contract generation is a controller-prepared candidate pending its PR, exact-head evidence, bootstrap CI, and protected integration.
