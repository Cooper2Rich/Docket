...
- [[build-readiness|Build readiness]] - Specification-only reset; 115 leaf contracts and eight gates prepared, external controller fixture-tested, GitHub publication verified, and every issue except tracking group #1 labeled blocked while graph blockers remain authoritative; no build authorized.
