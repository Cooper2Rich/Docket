...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first eight foundation leaves are integrated, while the required-check workflow foundation is a controller-prepared candidate pending its PR, exact-head evidence, bootstrap CI, and protected integration.
