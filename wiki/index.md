...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first three foundation leaves are integrated, while deterministic runtime fixtures and guarded adapters are proposed in PR #171 pending exact-head evidence, bootstrap CI, and controller-verified protected integration.
