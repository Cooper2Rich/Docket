...
- [[build-readiness|Build readiness]] - Specification-only reset; 115 leaf contracts and eight gates prepared, external controller fixture-tested, GitHub publication verified; foundation integration and private-repository protection block activation; no build authorized.
