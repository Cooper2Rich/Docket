...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; eleven leaves through `R1-IDA-001-A` are controller-verified and integrated, while `R1-IDA-001-B` is a locally verified candidate pending final commit, actual-PR exact-head evidence, hosted checks and protected integration.
