...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first nine foundation leaves are integrated, while the bootstrap-to-main promotion gate is a controller-prepared candidate pending its PR, final-head evidence, all eleven required checks, and protected integration.
