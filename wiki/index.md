...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first five foundation leaves are integrated, while isolated database integration and compatibility verification are proposed in PR #173 pending exact-head evidence, bootstrap CI, and controller-verified protected integration.
