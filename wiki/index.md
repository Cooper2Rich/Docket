...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first seven foundation leaves are integrated, while cross-release acceptance traceability is a controller-prepared candidate pending its PR, exact-head evidence, bootstrap CI, and protected integration.
