...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the first four foundation leaves are integrated, while module-owned forward migrations are proposed in PR #172 pending exact-head evidence, bootstrap CI, and controller-verified protected integration.
