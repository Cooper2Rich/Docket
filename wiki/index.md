...
- [[build-readiness|Build readiness]] - Build and Sol/high authorized; the workspace and web-foundation leaves are integrated, while the local-service/runtime foundation is proposed in PR #170 pending exact-head evidence, bootstrap CI, and controller-verified protected integration.
