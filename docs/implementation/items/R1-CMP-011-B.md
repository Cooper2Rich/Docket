# R1-CMP-011-B: Correct completed decisions and apply scoped disqualification

Parent: R1-CMP-011 · Order: 760 · Owner: competition · Stage: 05 Preliminary competition
...
- Completed and independently verified leaves: R1-CMP-011-A.
- External/decision gates: none unique to this leaf; protected integration and review still apply.
- Read AGENTS.md, wiki/index.md, BUILD.md, CONTEXT.md and the applicable ADRs; then the scoped sources below. Future commands are created by the named foundation dependencies and are not currently implemented.

## Acceptance criteria

- **R1-CMP-011-B/AC-01** — Only Director may correct a Completed decision for verified input error or Ruleset-authorized disqualification, never adjudication disagreement. Confirm an exact impact preview and preserve original Judge attribution.
- **R1-CMP-011-B/AC-02** — Round-only loss, prospective removal and full-tournament disqualification have separate scope. Retroactive forfeits require explicit Ruleset authority and a separate completed-decision correction for each affected round.
- **R1-CMP-011-B/AC-03** — Preserve as-played assignments, feedback and original point provenance; elimination remains point-free. Changed inputs invalidate the preview, and affected public values receive minimized versioned Correction Notices.
...
| --- | --- | --- | --- |
| item | `pnpm verify:item --id R1-CMP-011-B --contract docs/implementation/queue-contract.json` | R1-FND-001-A | Exact acceptance-ID set; every required scenario has at least one executed assertion, zero failed/skipped/pending assertions, current code revision and contract digest, hashed evidence artifacts. |
...
Write machine evidence to `.ralph/evidence/R1-CMP-011-B/acceptance.json` using [the verification protocol](../verification-protocol.md). The independent expected sets are stored in `docs/implementation/queue-contract.json`; the worker cannot reduce them.
...
- [wiki/ballot-model.md](https://github.com/Cooper2Rich/Docket/blob/codex/release-1-issue-setup/wiki/ballot-model.md): Completed-round decision correction; Disqualification scope. Clauses: SRC-43f3ef1f-100, SRC-43f3ef1f-101, SRC-43f3ef1f-102, SRC-43f3ef1f-103, SRC-43f3ef1f-104, SRC-43f3ef1f-105, SRC-43f3ef1f-106, SRC-43f3ef1f-107, SRC-43f3ef1f-108, SRC-43f3ef1f-109, SRC-43f3ef1f-110.
